...
var BroadcastEvent = (function (_super) {
    ...
    function BroadcastEvent(broadcastId, username, expirationDate) {
        if (broadcastId === void 0) { broadcastId = ''; }
        if (username === void 0) { username = ''; }
        if (expirationDate === void 0) { expirationDate = null; }
        var _this = _super.call(this, entity_model_type_1.ENTITY_MODELS.SYSTEM.BROADCAST_USER_MESSAGE_INSTANCE, BroadcastEvent.createId(broadcastId, username), true) || this;
